...
--
-- Database: `balostore19`
--
CREATE DATABASE IF NOT EXISTS `balostore19` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `balostore19`;
...
CREATE TABLE IF NOT EXISTS `db_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `mail_smtp` varchar(68) CHARACTER SET utf8 NOT NULL COMMENT 'Email shop',
  `mail_smtp_password` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Password mail shop',
  `mail_noreply` varchar(68) CHARACTER SET utf8 NOT NULL COMMENT 'Email quảng cáo không trả lời',
  `priceShip` mediumtext CHARACTER SET utf8 NOT NULL COMMENT 'Giá ship cố định',
  `title` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT 'Tên shop trên web',
  `description` text CHARACTER SET utf8 NOT NULL COMMENT 'Mô tả về shop',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `db_customer` (
  `phone` varchar(13) CHARACTER SET utf8 NOT NULL COMMENT 'Coi như id cho customer',
...
INSERT INTO `db_usergroup` (`id`, `name`, `created`, `created_by`, `modified`, `modified_by`, `status`) VALUES
(1, 'Toàn quyền', '2021-11-01 00:00:00', 1, '2019-05-14 23:29:15', 1, 1),
(2, 'Nhân viên', '2021-11-01 00:00:00', 1, '2019-05-14 23:29:21', 1, 1);
...
--
-- Constraints for table `db_token`
--
ALTER TABLE `db_token`
  ADD CONSTRAINT `db_token_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `db_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
